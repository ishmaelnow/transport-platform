...
begin
  ...
  insert into public.driver_applications (tenant_id, full_name, email, phone) values (target_tenant_id, btrim(applicant_name), lower(btrim(applicant_email)), nullif(btrim(applicant_phone), '')) returning driver_application_id into application_id;
